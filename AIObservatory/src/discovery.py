...
def run_hybrid_discovery():
    ...
    custom_noise = [
        ...
        'evaluated', 'grammer', 'displayed', 'table_select', 'más_qué', 'card_amex', 'cup', 'eligible', 'evening', 'ending', 'groups', 'pp', 'chargeout', 'square', 'organize', 'head', 'hmm', 'pasting', 'includes', 'minimum', 'mismo', 'compartir', 'firm', 'learned', 'tema', 'espero', 'creation', 'managed', 'traffic', 'mistakes', 'developers', 'clicking', 'dropdown', 'interviewer', 'recruiter',
        'pays', 'fifth', 'populate', 'games', 'data_risk', 'flip', 'ideal', 'select_table', 'sk', 'vl', 'qué_información', 'facing', 'leading', 'parts', 'attend', 'enter', 'headings', 'carry', 'problems', 'tan', 'worry', 'scratch', 'finish', 'certain', 'leaves', 'agreed', 'looping', 'am', 'improved', 'declined', 'tue', 'wed', 'br', 'supp', 'cid', 'prioritize', 'unnecessary', 'subjects', 'diego'
    ]
